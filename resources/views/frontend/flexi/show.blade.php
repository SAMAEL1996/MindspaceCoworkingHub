                ...
                <div class="col-md-8 col-lg-7 col-xl-6 col-xxl-5 mx-auto">
                    <form action="{{ route('flexi.remaining-time') }}" method="post">
                        ...
                        <div class="form-floating mb-4">
                            <input id="form_name" type="text" name="contact" class="form-control" placeholder="Jane" required value="{{ request()->has('contact') ? \Illuminate\Support\Facades\Crypt::decryptString(request('contact')) : '' }}">
